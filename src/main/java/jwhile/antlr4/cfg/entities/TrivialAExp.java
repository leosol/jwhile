...
public class TrivialAExp extends AExp {

	private Identifier identifier;
	private Literal literal;

	protected TrivialAExp(Identifier identifier) {
		this(identifier, null);
	}

	protected TrivialAExp(Literal literal) {
		this(null, literal);
	}

	protected TrivialAExp(Identifier identifier, Literal literal) {
